...
export default function StartClassPopup({ toggleFunc, classs }) {
      ...
      <div className="fixed inset-0 flex items-center justify-center h-screen w-auto z-10">
        <div className="w-[360px] bg-customPopupBgColor p-4 pt-2 pb-8 rounded-3xl font-sans space-y-3 border border-gray-300">
          ...
          <div className=" flex justify-center ">
            <button
              className="flex flex-row items-center justify-center py-3 px-9 mt-2 bg-customGreen w-8/12 text-white text-sm font-normal rounded-3xl space-x-2"
              onClick={toggleFunc}
            >
              Start Class
