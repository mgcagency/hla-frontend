...
export default function GiveReviewPopup({
  toggleFunc,
  reviewModal,
  toggleReviewModal,
  classs,
        ...
        <div className="w-[360px] bg-customPopupBgColor p-4 pt-2 pb-8 rounded-3xl font-sans space-y-3 border border-gray-300">
          ...
          <div className="flex justify-between mb-4">
            ...
            <div className="flex-[3] flex justify-between mb-3">
              <p className="font-medium mt-2 text-2xl">Give Review</p>
              <div
                onClick={toggleFunc}
          ...
          <div className="h-[220px] space-y-2 px-3 text-customGray font-medium">
            <div className="flex flex-row items-center">
              <p className="text-xl mr-2">{classs.title}</p>
              <div className="px-4 py-1 rounded-full bg-customGreen text-white text-xxs font-normal">
                Completed
              </div>
            </div>
            ...
            {classs.location.name === "Student's Home" ||
            classs.location.name === "Face to Face" ? (
            ...
            ) : classs.location.name === "Virtual" ||
              classs.location.name === "Learning Pack" ||
              classs.location.name === "Online Course" ? (
              <div className="text-customYellow flex flex-row items-center gap-2">
                <BiLink size={22} />
