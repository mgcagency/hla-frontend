...
export default function TasksDropDown({ selectedOption, setSelectedOption }) {
    ...
    <Menu as="div" className="relative inline-block text-left">
      ...
      >
        <div className="py-1">
          <MenuItem>
            <p
              className="block px-4 py-2 text-sm text-customGray font-medium hover:bg-gray-200 rounded-xl cursor-pointer"
              onClick={() => {
