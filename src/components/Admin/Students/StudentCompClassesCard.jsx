...
export default function CompletedClassesCard({ colors, classs }) {
  ...
  return (
    // whole card div
    <div
      className={`border rounded-2xl ${colors[2]} ${colors[1]} font-sans text-customGray pt-3 pb-1 pl-3 pr-3`}
    >
      {/* Upper Div  */}
