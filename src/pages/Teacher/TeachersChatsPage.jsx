...
export default function TeacherChatsPage() {
  ...
  // const { socket, setIsSocketEnabled } = useSocket();
  ...
  // console.log("isAllChatsData: ", allChats);
            ...
            <div className="flex-[2] flex flex-col pr-4 py-5 ">
              ...
              <div className="flex-[10] flex flex-col-reverse pl-4">
                          ...
                          messages: [
                            {
                              ...
                              mediaType: "text",
                              sender: user._id, // Assuming user._id is available
                              timestamp: new Date(),
                            },
                          ],
                        })
                ...
                {/* <div className="flex flex-col-reverse gap-y-3">
                  {allMsgs.slice().reverse().map((msg, index) => (
                    <div key={index} className="text-black">{msg.content}</div>
                  ))} */}
                {/* Msg Received */}
                {/* <div className="flex flex-row space-x-2">
                    ...
                    <div className="flex p-3 max-w-[90vh] rounded-r-xl rounded-bl-xl sm:rounded-r-3xl sm:rounded-bl-3xl md:rounded-r-full md:rounded-bl-full bg-customYellowShade ">
                      <p className="text-black text-sm font-normal">
                        {" "}
                        {receiveMsg !== ""
                          ? receiveMsg
                          : "Yes, I am available RN."}
                      </p>
                      <div className="flex flex-row ml-7 mt-[2px] text-customGray text-xxs font-medium">
                        <p className="mt-[2px]">18:19</p>
                        <IoIosCheckmark size={18} />
                      </div>
                    </div>
                  </div> */}
                {/* Msg Sent  */}
                {/* <div className="flex px-4 p-3 rounded-l-3xl rounded-tr-3xl md:rounded-l-full md:rounded-tr-full ml-auto max-w-[90vh]  bg-customMaroon">
                    <p className="text-white text-sm font-normal">
                      {sentMsg !== ""
                        ? sentMsg
                        : "Hi Miss, are you available for a quick online class?"}
                    </p>
                    <div className="flex flex-row ml-7 mt-[2px] text-customLightGray text-xxs font-medium">
                      <p className="mt-[2px]">18:16</p>
                      <IoIosCheckmark size={18} />
                    </div>
                  </div>
                </div> */}
